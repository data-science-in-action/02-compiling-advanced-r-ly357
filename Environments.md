...
```r
e1
#> <environment: 0x000000000e9b2f20>
```
...
#> Error in global_env() == current_env(): 只能比较(1)基元或串列种类
```
...
```r
env_parent(e2b)
#> <environment: 0x0000000015843308>
env_parent(e2a)
...
```r
env_parents(e2b)
#> [[1]]   <env: 0000000015843308>
#> [[2]] $ <env: global>
env_parents(e2d)
#> [[1]]   <env: 0000000015FCCCE0>
#> [[2]] $ <env: empty>
```
...
```r
e3[[1]]
#> Error in e3[[1]]: 取子集环境时的参数不对

e3[c("x", "y")]
#> Error in e3[c("x", "y")]: 类别为'environment'的对象不可以取子集
```
...
env_get(e3, "xyz")
#> Error in env_get(e3, "xyz"): 找不到对象'xyz'
```
...
plus_one
#> function(y) x + y
#> <environment: 0x000000001453d7c0>
```
