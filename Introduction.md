...
This version of the book was built with R version 3.6.3 (2020-02-29) and the following packages.


|package     |version    |source                         |
|:-----------|:----------|:------------------------------|
|bench       |1.1.1      |CRAN (R 3.6.3)                 |
|bookdown    |0.18       |CRAN (R 3.6.3)                 |
|dbplyr      |1.4.2      |CRAN (R 3.6.3)                 |
|desc        |1.2.0      |CRAN (R 3.6.3)                 |
|emo         |0.0.0.9000 |Github (hadley/emo\@3f03b11)   |
|ggbeeswarm  |0.6.0      |CRAN (R 3.6.3)                 |
|ggplot2     |3.3.0      |CRAN (R 3.6.3)                 |
|knitr       |1.28       |CRAN (R 3.6.3)                 |
|lobstr      |1.1.1      |CRAN (R 3.6.3)                 |
|memoise     |1.1.0      |CRAN (R 3.6.3)                 |
|png         |0.1-7      |CRAN (R 3.6.0)                 |
|profvis     |0.3.6      |CRAN (R 3.6.3)                 |
|Rcpp        |1.0.3      |CRAN (R 3.6.3)                 |
|rlang       |0.4.5      |CRAN (R 3.6.3)                 |
|rmarkdown   |2.1        |CRAN (R 3.6.3)                 |
|RSQLite     |2.2.0      |CRAN (R 3.6.3)                 |
|scales      |1.1.0      |CRAN (R 3.6.3)                 |
|sessioninfo |1.1.1      |CRAN (R 3.6.3)                 |
|sloop       |1.0.1      |Github (hadley/sloop\@0f39299) |
|testthat    |2.3.2      |CRAN (R 3.6.3)                 |
|tidyr       |1.0.2      |CRAN (R 3.6.3)                 |
|vctrs       |0.2.4      |CRAN (R 3.6.3)                 |
|zeallot     |0.1.0      |CRAN (R 3.6.3)                 |
