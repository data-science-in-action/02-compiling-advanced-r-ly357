...
getwd()
#> [1] "D:/git/homework/02-compiling-advanced-r-Wendy-Stan/adv-r"
with_dir("~", getwd())
#> [1] "F:/Users/My/Documents"
```
...
1.  We can use `on.exit()` to implement a simple version of `capture.output()`.
    ...
    #> \Users\My\AppData\Local\Temp\RtmpspeNCY\file434ca44560e'，原因
    #> 是'Permission denied'
    #> [1] "a" "b" "c"
    ```
...
str(k01(1, 3, b = 1))
#> Error in k01(1, 3, b = 1): 参数3有多个与之相对应的正式参数
```
...
x <- k01(a = 1, 2, 3)
#> Warning in k01(a = 1, 2, 3): 'a'部分匹配为'abcdef'
```
