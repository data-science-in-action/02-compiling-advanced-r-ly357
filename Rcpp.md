...
add
#> function (x, y, z) 
#> .Call(<pointer: 0x00000000712815a0>, x, y, z)
add(1, 2, 3)
#> [1] 6
```
...
#> 1 sum(x)        1.1μs    1.5μs   583870.        0B     0   
#> 2 sumC(x)       2.1μs    3.2μs   302344.    2.49KB     0   
#> 3 sumR(x)      48.8μs   49.7μs    18931.   35.66KB     2.02
```
...
#>   expression          min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>     <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 pdistR(0.5, y)   8.41ms   9.03ms      99.8    7.63MB     48.2
#> 2 pdistC(0.5, y)   7.61ms   7.79ms     127.     7.63MB     42.5
```
...
#>   expression              min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>         <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 gibbs_r(100, 10)     4.21ms   4.56ms      214.    4.97MB     41.2
#> 2 gibbs_cpp(100, 10)  225.3μs  263.6μs     3633.     4.1KB     23.7
```
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 vacc1        1.69ms   1.93ms      509.    7.86KB    27.4 
#> 2 vacc2        90.6μs   97.9μs     9304.  153.14KB    26.8 
#> 3 vacc3        48.9μs   49.7μs    19128.   14.48KB     6.13
```
